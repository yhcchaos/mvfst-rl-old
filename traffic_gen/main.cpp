...
DEFINE_string(cc_env_actions, "0,/2,/1.5,/1.2,/1.1,/1.05,*1.05,*1.1,*1.2,*1.5,*2",
...
DEFINE_double(cc_env_reward_packet_loss_factor, 1.0,
...
DEFINE_double(cc_env_bandwidth, 1.0, "Connection Bandwidth (mbps)");
DEFINE_double(cc_env_delay, 0.0, "Connection delay (ms)");
...
makeRLCongestionControllerFactory() {
  ...
  cfg.bandwidth = FLAGS_cc_env_bandwidth;
  cfg.delay = FLAGS_cc_env_delay;
  cfg.lossRatio = FLAGS_cc_env_loss_ratio;
